...
:
    ...
    nu0_(tempBirdCarreauCoeffs_.lookup("nu0")),
    nuInf_(tempBirdCarreauCoeffs_.lookup("nuInf")),
    k_(tempBirdCarreauCoeffs_.lookup("k")),
    n_(tempBirdCarreauCoeffs_.lookup("n")),
    a_(tempBirdCarreauCoeffs_.lookup("a")),
    Tbase_(tempBirdCarreauCoeffs_.lookup("Tbase")),
...
)
{
    ...
    tempBirdCarreauCoeffs_.lookup("nu0") >> nu0_;
    tempBirdCarreauCoeffs_.lookup("nuInf") >> nuInf_;
    tempBirdCarreauCoeffs_.lookup("k") >> k_;
    tempBirdCarreauCoeffs_.lookup("n") >> n_;
    tempBirdCarreauCoeffs_.lookup("a") >> a_;
    tempBirdCarreauCoeffs_.lookup("Tbase") >> Tbase_;
