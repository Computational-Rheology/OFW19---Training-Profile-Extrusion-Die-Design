...
# Main steps:
1. in the Module "Part Design" edit the geometry file in FreeCAD and use the export command to create an stl file or each patch (use ast format to export the stl file in ascii, then change the extension to stl), using the shape boundary binder
